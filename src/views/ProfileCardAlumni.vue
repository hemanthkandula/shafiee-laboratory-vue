...
<!--            &lt;!&ndash;<li class="at-social__item">&ndash;&gt;-->
<!--                &lt;!&ndash;<a href="">&ndash;&gt;-->
<!--                    &lt;!&ndash;<img alt="" height="18" src="../assets/icons/icon-google-scholar.svg" width="18"/>&ndash;&gt;-->

<!--                &lt;!&ndash;</a>&ndash;&gt;-->
<!--            &lt;!&ndash;</li>&ndash;&gt;-->
<!--            &lt;!&ndash;<li class="at-social__item"><a href="">&ndash;&gt;-->
<!--                &lt;!&ndash;<svg height="18" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg">&ndash;&gt;-->
<!--                    &lt;!&ndash;<path d="M20.875 7.5v.563c0 3.28-1.18 6.257-3.54 8.93C14.978 19.663 11.845 21 7.938 21c-2.5 0-4.812-.687-6.937-2.063.5.063.86.094 1.078.094 2.094 0 3.969-.656 5.625-1.968a4.563 4.563 0 0 1-2.625-.915 4.294 4.294 0 0 1-1.594-2.226c.375.062.657.094.844.094.313 0 .719-.063 1.219-.188-1.031-.219-1.899-.742-2.602-1.57a4.32 4.32 0 0 1-1.054-2.883c.687.328 1.375.516 2.062.516C2.61 9.016 1.938 7.75 1.938 6.094c0-.782.203-1.531.609-2.25 2.406 2.969 5.515 4.547 9.328 4.734-.063-.219-.094-.562-.094-1.031 0-1.281.438-2.36 1.313-3.234C13.969 3.437 15.047 3 16.328 3s2.375.484 3.281 1.453c.938-.156 1.907-.531 2.907-1.125-.313 1.094-.985 1.938-2.016 2.531.969-.093 1.844-.328 2.625-.703-.563.875-1.312 1.656-2.25 2.344z"&ndash;&gt;-->
